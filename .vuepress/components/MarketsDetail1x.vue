<template>
    <div class="markets-main">
        ...
        <div class="markets-tis">注意：本页面为【旧】市场，<strong><u>仅支持1.0+（不支持2.0）</u></strong>主程序版本，<a href="../markets/">立即前往新插件市场&gt;&gt;</a></div>
...
<script>
    ...
    export default {
        ...
        methods: {
            goBack() {
                if (window.sessionStorage['__FromPath__'] === '/markets-old/') {
                    window.history.go(-1);
                }else{
                    this.$router.push({path: '/markets-old'});
                }
            },
